...
const ROW_HEIGHT = 52;
/** Fixed preview slot — real frame size is shown in the label. */
const PREVIEW_MAX_SIZE = 44;
...
export class SpriteAtlasDebugPanel extends Container {
  ...
  constructor(sheet: Spritesheet) {
    ...
    const frameNames = Object.keys(sheet.textures).sort((a, b) => a.localeCompare(b));
